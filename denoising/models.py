...
class FFDNet(nn.Module):
    ...
    def __init__(self, num_input_channels):
        ...
        # Cambiamos el nombre para que coincida con los pesos
    ...
    def load_state_dict(self, state_dict):
        """Maneja la carga de pesos con prefijo 'module'"""
        new_state_dict = {}
        for k, v in state_dict.items():
            if k.startswith('module.'):
                name = k[7:]  # remueve el prefijo 'module.'
            else:
                name = k
            new_state_dict[name] = v
        super(FFDNet, self).load_state_dict(new_state_dict, strict=False)
